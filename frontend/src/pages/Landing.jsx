...
const FORM_BEASISWA     = "https://forms.gle/h81JZnKeeJgm9StZA";
...
export default function Landing() {
  return (
    <div className="min-h-screen bg-paper text-ink overflow-x-hidden">
      ...
      {/* ============ PILIH FORM ============ */}
      <section id="isi-form" className="isolate px-6 pb-24 -mt-0 sm:-mt-60">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="bg-surface rounded-2xl border border-line shadow-card p-6 flex flex-col">
              <div className="w-11 h-11 rounded-xl bg-greensoft flex items-center justify-center mb-4">
                <Landmark size={22} className="text-green" strokeWidth={1.8} />
              </div>
